...
@section('header_title', 'Registro de Gastos y Compras Operativas')
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
    <div>
        <h3 style="color: #3E2723;">Gastos Operativos Registrados</h3>
        <p style="color: #666; font-size: 0.9rem;">Total acumulado: <strong>${{ number_format($totalExpenses, 2) }}</strong></p>
    </div>
...
<div style="background: white; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); overflow: hidden;">
    <table style="width: 100%; border-collapse: collapse; text-align: left;">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="6" style="padding: 15px; text-align: center; color: #888;">No hay gastos registrados en MySQL.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
