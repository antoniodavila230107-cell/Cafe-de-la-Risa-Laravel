...
@if(session('success'))
<div id="flashSuccessMsg" style="background: #E8F5E9; color: #2E7D32; border: 1px solid #A5D6A7; border-radius: 8px; padding: 12px 16px; margin-bottom: 1rem; font-weight: 600; transition: opacity 0.5s ease;">
    ✅ {{ session('success') }}
</div>
<script>
    setTimeout(function() {
        const msg = document.getElementById('flashSuccessMsg');
        if (msg) {
            msg.style.opacity = '0';
